...
availability_status, availability_data = sdk.search_availability(itinerary=[
    SearchAvailabilityItinerary(id="1", origin_location_code="CDG", destination_location_code="FRA",
                                departure_date="2025-11-16"),
    SearchAvailabilityItinerary(id="2", origin_location_code="FRA", destination_location_code="CDG",
