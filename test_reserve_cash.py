...
sdk = FlightSDK(debug=True, prefix_ama_ref="Test", suffix_ama_ref="user1", currency=Currency.JMD)
...
# AVIANCA: AV - IBERIA: IB - AIR FRANCE: AF
    ...
    if pricing_status == 200:
        reserve_status, reserve_data = sdk.reserve(
            ...
            travelers=[
                ReservePax(
                    id="1",
                    date_of_birth="1992-12-28",
                    first_name="Jose Angel",
                    last_name="Alvarez Abraira",
                    gender=Gender.MALE,
                    email="jaalvarez2818@gmail.com",
                    phone_country_code="34",
                    phone_number="697676672",
                    document_type=DocumentType.PASSPORT,
                    document_number="K111111",
                    document_issuance_date="2024-05-01",
                    document_expiry_date="2026-05-01",
                    document_issuance_country_code="CU",
                    nationality_code="CU"
                ),
                ReservePax(
                    id="2",
                    ...
                    first_name="Chabelly",
                    last_name="Motes Penna",
                    gender=Gender.FEMALE,
                    email="chabellyprueba123@gmail.com",
                    phone_country_code="53",
                    phone_number="55555554",
                    document_type=DocumentType.PASSPORT,
                    document_number="K222222",
                    document_issuance_date="2024-06-01",
                    document_expiry_date="2026-06-01",
                    document_issuance_country_code="ES",
                    nationality_code="ES"
                ),
                ReservePax(
                    id="3",
                    ...
                    first_name="Eleany",
                    last_name="Gutierrez Morrell",
                    gender=Gender.FEMALE,
                    email="eleanyprueba123@gmail.com",
                    phone_country_code="53",
                    phone_number="55555555",
                    document_type=DocumentType.PASSPORT,
                    document_number="K333333",
                    document_issuance_date="2024-07-01",
                    document_expiry_date="2026-07-01",
                    document_issuance_country_code="US",
                    nationality_code="US"
                ),
                ReservePax(
                    id="4",
                    date_of_birth="2025-04-22",
                    first_name="Iris",
                    last_name="Estevez",
                    gender=Gender.FEMALE,
