...
if availability_status == 200:
    ...
    if pricing_status == 200:
        reserve_status, reserve_data = sdk.reserve(
            ...
            issue=True,
            travelers=[
                ReservePax(id="1", date_of_birth="1992-12-29", first_name="Jose Angel", last_name="Alvarez Abraira",
                           gender=Gender.MALE, email="jaalvarez2818development@gmail.com", phone_country_code="34",
                           phone_number="697676672", document_type=DocumentType.PASSPORT, document_number="K222222",
